...
//   https://kawauso-29.com/js/imgchange/
  let imgList = {image1:"./images/img1.jpg", image2:"./images/img2.jpg", image3:"./images/img2.jpg"};
  let num = 1;
  document.getElementById('test_img1').addEventListener('click', function(){
    num++;
    let imgPath = "http://kawauso-29.com/wp-content/uploads/2020/04/"+imgList['image'+num];
